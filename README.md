This is a very simple app that I can practice CRUD operations against a real database. In this project I am using ADO.NET, because it’s the closest to raw SQL.
